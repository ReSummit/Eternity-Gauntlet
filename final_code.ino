...
void loop() {
  ...
  */
  ...
  float thumbPulseLen = constrain(map(thumbFlexR, SHORT_STRAIGHT_RESISTANCE, SHORT_BEND_RESISTANCE, SERVOT_MIN, SERVOT_MAX), SERVOT_MIN, SERVOT_MAX);
  ...
  */
  ...
  //float gyroAngle = constrain(map(pitch, -90, 90, 0, 180.0), 0, 180);
  //float gyroPulseLen = constrain(map(gyroAngle, 0, 180.0, SERVOG_MIN, SERVOG_MAX), SERVOG_MIN, SERVOG_MAX);
  float gyroPulseLen = constrain(map(pitch, -90, 90.0, SERVOG_MIN, SERVOG_MAX), SERVOG_MIN, SERVOG_MAX);
